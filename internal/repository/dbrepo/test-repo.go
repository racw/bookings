...
func (m *testDBRepo) InsertReservation(res models.Reservation) (int, error) {
	// if the room id is 12, return an error; otherwise, pass
	if res.RoomID == 12 {
		return 0, errors.New("no room found")
	}
	return 1, nil
}
...
func (m *testDBRepo) SearchAvailabilityByDatesByRoomID(start, end time.Time, roomID int) (bool, error) {
	...
	// if the start date is after 2049-12-31, return false
	// indicating that there is no availability
	if start.After(t) {
		return false, nil
	}
...
func (m *testDBRepo) SearchAvailabilityForAllRooms(start, end time.Time) ([]models.Room, error) {
	...
	// otherwise, put an entry into the slice
	room := models.Room{
		ID:       1,
...
func (m *testDBRepo) DeleteByBlockID(id int) error {
	return nil
}
